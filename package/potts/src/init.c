...
static R_NativePrimitiveArgType potts_types[5] =
    {RAWSXP, REALSXP, INTSXP, INTSXP, INTSXP};

static R_NativeArgStyle potts_styles[5] =
    {R_ARG_IN_OUT, R_ARG_IN, R_ARG_IN, R_ARG_IN, R_ARG_OUT};
...
static R_CMethodDef cMethods[] = {
    ...
    {"potts", (DL_FUNC) &potts, 5, potts_types, potts_styles},
