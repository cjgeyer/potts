...
static R_NativePrimitiveArgType potts_types[7] =
    {RAWSXP, REALSXP, INTSXP, INTSXP, INTSXP, INTSXP, REALSXP};

static R_NativeArgStyle potts_styles[7] =
    {R_ARG_IN_OUT, R_ARG_IN, R_ARG_IN, R_ARG_IN, R_ARG_IN, R_ARG_IN, R_ARG_OUT};
...
static R_CMethodDef cMethods[] = {
    ...
    {"potts", (DL_FUNC) &potts, 7, potts_types, potts_styles},
